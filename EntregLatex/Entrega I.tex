...
%ADD BLOCKS
\begin{center}
\begin{tikzpicture}[node distance=0.7cm and 0.8cm, auto, align=center]
...
\node[cas, below = of CreateRegion](SelectRegion){Seleccionar\\regió};
\node[cas, below = of SelectRegion](ViewSolutionable){Veure si\\té solució};
