...
%ADD ARROWS
\begin{center}
\begin{tikzpicture}[node distance=1cm and 1.5cm, auto, align=center]
...
\node[UML, below = of BoardCreator](BoardHumanEditor){BoardHumanEditor};
\node[UML, below right = of BoardCreator](BoardCPUGenerator){BoardCPUGenerator};
