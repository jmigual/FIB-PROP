        ...
        while (!finish) {
            ...
            switch (in.nextInt()) {
                ...
                case 4:
                    ...
                    out.println("3. Veure anotacions d'una cel路la");

                    switch (in.nextInt()) {
                        case 1:
                            out.println("Introdueix fila, columna de cel路la i numero de l'anotacio");
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            out.println("Introdueix fila, columna de cel路la");
